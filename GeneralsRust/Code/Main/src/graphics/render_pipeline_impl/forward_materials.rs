...
impl ForwardPass {
    ...
    pub(super) fn build_material_pass(&mut self, material: &W3DMaterial) -> Result<MaterialPassClass> {
    ...
    pub(super) fn stage_layer_offset(mesh: &crate::assets::models::W3DMesh, pass_index: usize) -> usize {
    ...
    pub(super) fn ensure_texture(&mut self, texture_name: &str) -> Result<Option<Arc<TextureClass>>> {
    ...
    pub(super) fn create_texture_from_cached_assets(&self, texture_name: &str) -> Result<Arc<TextureClass>> {
        let asset_manager =
    ...
    pub(super) fn build_texture(&self, texture_name: &str, raw: &RawTexture) -> Result<Arc<TextureClass>> {
