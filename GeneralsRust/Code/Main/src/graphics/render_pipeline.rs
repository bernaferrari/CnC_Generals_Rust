...
static RESIDUAL_PB_ACTION: std::sync::atomic::AtomicU8 = std::sync::atomic::AtomicU8::new(0);
static RESIDUAL_PB_OK: std::sync::atomic::AtomicBool = std::sync::atomic::AtomicBool::new(false);

fn residual_pb_action_store(action: ResidualPresentationBoundaryAction) {
