...
pub use super::*;
    ...
    fn presentation_path_prefers_local_drawable_tick() {
        let cnc = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/cnc_game_engine.rs"));
        assert!(
        ...
        let gc = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../GameEngine/GameClient/src/core/game_client.rs"));
        assert!(
    ...
    fn presentation_shell_update_is_wired() {
        ...
        let engine_src = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/cnc_game_engine.rs"));
        assert!(
    ...
    fn presentation_particle_client_mirror_same_frame() {
        ...
        let cp = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/game_logic/combat_particles.rs"));
        assert!(
    ...
    fn presentation_audio_processed_same_frame_after_apply() {
        ...
        let gl = include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/src/game_logic/game_logic.rs"));
        assert!(
