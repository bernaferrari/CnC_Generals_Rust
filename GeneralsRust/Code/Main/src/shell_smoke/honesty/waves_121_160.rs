...
pub(super) fn evaluate(pres: &crate::presentation_frame::PresentationFrame, presentation_ok: bool) -> Waves121160 {
    ...
    Waves121160 {
        ...
        single_player_control_names_wave131_ok: honesty_single_player_menu_control_names_residual_wave131(),
        single_player_nav_commands_wave131_ok: honesty_single_player_menu_nav_commands_residual_wave131(),
        ...
        difficulty_select_control_names_wave134_ok: honesty_difficulty_select_control_names_residual_wave134(),
        difficulty_select_nav_commands_wave134_ok: honesty_difficulty_select_nav_commands_residual_wave134(),
        loading_screen_stages_wave135_ok: honesty_loading_screen_stages_residual_wave135(),
        loading_screen_nav_commands_wave135_ok: honesty_loading_screen_nav_commands_residual_wave135(),
        ...
        popup_communicator_control_names_wave139_ok: honesty_popup_communicator_control_names_residual_wave139(),
        popup_communicator_nav_commands_wave139_ok: honesty_popup_communicator_nav_commands_residual_wave139(),
        replay_control_control_names_wave140_ok: honesty_replay_control_control_names_residual_wave140(),
        replay_control_nav_commands_wave140_ok: honesty_replay_control_nav_commands_residual_wave140(),
        ...
        control_bar_resizer_method_names_wave147_ok: honesty_control_bar_resizer_method_names_residual_wave147(),
        control_bar_resizer_nav_commands_wave147_ok: honesty_control_bar_resizer_nav_commands_residual_wave147(),
        under_construction_method_names_wave148_ok: honesty_under_construction_method_names_residual_wave148(),
        under_construction_nav_commands_wave148_ok: honesty_under_construction_nav_commands_residual_wave148(),
        structure_inventory_command_names_wave149_ok: honesty_structure_inventory_command_names_residual_wave149(),
        structure_inventory_nav_commands_wave149_ok: honesty_structure_inventory_nav_commands_residual_wave149(),
        ...
        challenge_generals_method_names_wave152_ok: honesty_challenge_generals_method_names_residual_wave152(),
        challenge_generals_nav_commands_wave152_ok: honesty_challenge_generals_nav_commands_residual_wave152(),
        gameworld_authority_env_names_wave153_ok: honesty_gameworld_authority_env_names_residual_wave153(),
        gameworld_authority_method_names_wave153_ok: honesty_gameworld_authority_method_names_residual_wave153(),
        gameworld_authority_nav_commands_wave153_ok: honesty_gameworld_authority_nav_commands_residual_wave153(),
        window_video_type_state_names_wave154_ok: honesty_window_video_type_state_names_residual_wave154(),
        ...
        main_menu_layout_nav_commands_wave155_ok: honesty_main_menu_layout_nav_commands_residual_wave155(),
        control_bar_scheme_names_wave156_ok: honesty_control_bar_scheme_names_residual_wave156(),
        control_bar_scheme_method_names_wave156_ok: honesty_control_bar_scheme_method_names_residual_wave156(),
        control_bar_scheme_nav_commands_wave156_ok: honesty_control_bar_scheme_nav_commands_residual_wave156(),
        presentation_boundary_method_names_wave157_ok: honesty_presentation_boundary_method_names_residual_wave157(),
        presentation_boundary_source_markers_wave157_ok: honesty_presentation_boundary_source_markers_residual_wave157(),
        presentation_boundary_nav_commands_wave157_ok: honesty_presentation_boundary_nav_commands_residual_wave157(),
        ...
        control_bar_print_nav_commands_wave158_ok: honesty_control_bar_print_nav_commands_residual_wave158(),
        terrain_env_boundary_method_names_wave159_ok: honesty_terrain_env_boundary_method_names_residual_wave159(),
        terrain_env_boundary_source_markers_wave159_ok: honesty_terrain_env_boundary_source_markers_residual_wave159(),
        terrain_env_boundary_nav_commands_wave159_ok: honesty_terrain_env_boundary_nav_commands_residual_wave159(),
