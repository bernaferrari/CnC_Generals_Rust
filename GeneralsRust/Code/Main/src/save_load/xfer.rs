...
fn write_kind_of_variant(kind_of: KindOf) -> u8 {
    match kind_of {
        ...
        KindOf::Hero => 13,
        KindOf::Powered => 14,
        KindOf::FSBarracks => 15,
        KindOf::FSWarFactory => 16,
        KindOf::FSAirfield => 17,
        KindOf::FSInternetCenter => 18,
        KindOf::FSPower => 19,
        KindOf::FSSupplyDropzone => 20,
        KindOf::FSSupplyCenter => 21,
        KindOf::FSSuperweapon => 22,
        KindOf::FSStrategyCenter => 23,
        KindOf::FSFake => 24,
...
fn read_kind_of_variant(variant: u8) -> SaveLoadResult<KindOf> {
    match variant {
        ...
        15 => Ok(KindOf::FSBarracks),
        16 => Ok(KindOf::FSWarFactory),
        17 => Ok(KindOf::FSAirfield),
        18 => Ok(KindOf::FSInternetCenter),
        19 => Ok(KindOf::FSPower),
        20 => Ok(KindOf::FSSupplyDropzone),
        21 => Ok(KindOf::FSSupplyCenter),
        22 => Ok(KindOf::FSSuperweapon),
        23 => Ok(KindOf::FSStrategyCenter),
        24 => Ok(KindOf::FSFake),
