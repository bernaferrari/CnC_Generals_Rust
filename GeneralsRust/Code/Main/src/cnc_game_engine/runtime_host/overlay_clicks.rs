...
impl CnCGameEngine {
    ...
    pub(super) fn runtime_host_cmd_click_control_bar_resizer(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_under_construction(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_structure_inventory(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_challenge_generals(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_main_menu_layout(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_control_bar_scheme(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_control_bar_print_positions(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_terrain_env_boundary(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_shell_skirmish_nav(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "push".to_string());
