...
impl CnCGameEngine {
    ...
    pub(super) fn runtime_host_cmd_click_skirmish_options_wnd(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
    ...
    pub(super) fn runtime_host_cmd_click_challenge_start(&mut self, args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_click_new_game_stream(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
    ...
    pub(super) fn runtime_host_cmd_click_w3d_main_menu_init(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
    ...
    pub(super) fn runtime_host_cmd_click_start_game_loading(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
