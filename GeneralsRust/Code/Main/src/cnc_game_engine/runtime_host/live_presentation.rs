...
impl CnCGameEngine {
    pub(super) fn runtime_host_cmd_click_gameworld_authority(
        &mut self,
        ...
        let wnd_ok = match action.as_str() {
            "refresh" => crate::gameworld_shadow::simulate_gameworld_authority_refresh_env(),
    ...
    pub(super) fn runtime_host_cmd_click_presentation_boundary(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
        ...
        let wnd_ok = match action.as_str() {
            ...
            "fallback" => crate::graphics::simulate_presentation_boundary_fallback_counter_source(),
    ...
    pub(super) fn runtime_host_cmd_click_live_map_load(&mut self, args: &HashMap<String, String>) {
        ...
        let ok = match action.as_str() {
            "defcon" | "lone_eagle" | "prepare" | "load" => false,
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_seed(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_shadow(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
            ...
            .unwrap_or_else(|| "prepare".to_string());
        let ok = match action.as_str() {
            "source" => crate::game_logic::honesty_seed_presentation_shadow_overlay_source(),
            "sync" | "overlay" | "prepare" => false,
            _ => self.host_unknown_action_fail_closed(false),
        };
        self.runtime_host_last_gameplay_cmd = if ok {
    ...
    pub(super) fn runtime_host_cmd_click_single_authority(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_presentation_client_boundary(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_golden_map_host_victory(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_executable_presentation_boundary(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
            ...
            .unwrap_or_else(|| "prepare".to_string());
        let ok = match action.as_str() {
            "vertical" | "fallback" | "prepare" => false,
            _ => self.host_unknown_action_fail_closed(false),
        };
        self.runtime_host_last_gameplay_cmd = if ok {
    ...
    pub(super) fn runtime_host_cmd_click_gameworld_production_authority(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_gameworld_sole_tick_coupling(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_gameworld_authority_matrix(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_production_writeback(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
            ...
            .unwrap_or_else(|| "prepare".to_string());
        let ok = match action.as_str() {
            "progress" | "writeback" | "prepare" => false,
            _ => self.host_unknown_action_fail_closed(false),
        };
        self.runtime_host_last_gameplay_cmd = if ok {
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_construction_writeback(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_damage_channel(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_economy_movement(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
            ...
            .unwrap_or_else(|| "prepare".to_string());
        let ok = match action.as_str() {
            "economy" | "movement" | "prepare" => false,
            _ => self.host_unknown_action_fail_closed(false),
        };
        self.runtime_host_last_gameplay_cmd = if ok {
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_projectile_ai(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_fire_special_power(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_presentation_view(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_gameworld_overlay(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_executable_gameworld_presentation(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_overlay_deepen(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
            ...
            .unwrap_or_else(|| "prepare".to_string());
        let ok = match action.as_str() {
            "velocity" | "selection" | "prepare" => false,
            _ => self.host_unknown_action_fail_closed(false),
        };
        self.runtime_host_last_gameplay_cmd = if ok {
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_overlay_stamp(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_gameworld_entity_view_deepen(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_append_missing(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_build_from_gameworld(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_from_gameworld_default(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_build_for_engine(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_rebuilt_vertical_gate(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_env_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_os_input_command_path(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_host_beacon_presentation(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_fow_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_ui_producer_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_ui_helpers_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_control_group_camera_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_cmd_filter_env_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_selection_commands_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_ui_command_selection_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_local_team_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_hotkey_move_attack_selection_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
        ...
        self.runtime_host_last_gameplay_cmd = if ok {
            ...
            format!("click_live_hotkey_move_attack_selection_presentation_only_miss_{action}")
        };
    }

    pub(super) fn runtime_host_cmd_click_live_pick_object_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_bootstrap_camera_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_force_complete_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_path_guard_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_hotkey_selection_camera_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_construct_spawn_pose_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_rmb_target_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_rmb_selected_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_engine_presentation_player_ui(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_rmb_presentation_full_classify(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_mouse_input_presentation_only(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_engine_player_ui_boot_peel(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_contain_module_overrides_fail_closed(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
