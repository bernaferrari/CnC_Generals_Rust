...
impl CnCGameEngine {
    pub(super) fn runtime_host_cmd_click_live_player_probe_api(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
    ...
    pub(super) fn runtime_host_cmd_click_live_player_team_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_player_field_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_camera_height_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_command_player_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_construct_economy_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_command_unit_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_selection_query_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_world_pick_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_object_registry_empty_fastpath(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_legacy_object_registry_fastpath(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_time_frozen_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_visual_speed_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
    ...
    pub(super) fn runtime_host_cmd_click_live_presentation_script_camera_probe(&mut self, args: &HashMap<String, String>)  {
                let action = args
                    .get("action")
                    .map(|v| v.trim().to_ascii_lowercase())
                    .unwrap_or_else(|| "prepare".to_string());
