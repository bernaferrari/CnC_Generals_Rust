...
impl CnCGameEngine {
    pub(super) fn runtime_host_cmd_open_single_player_menu(&mut self, _args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_click_single_player_menu(&mut self, args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_open_map_select_menu(&mut self, _args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_click_map_select_menu(&mut self, args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_open_single_player_menu_2(&mut self, _args: &HashMap<String, String>)  {
                let mut wnd_ok = false;
                #[cfg(feature = "game_client")]
                {
                    wnd_ok =
    ...
    pub(super) fn runtime_host_cmd_open_multiplayer_menu(&mut self, _args: &HashMap<String, String>)  {
                let mut wnd_ok = false;
                #[cfg(feature = "game_client")]
                {
                    wnd_ok =
    ...
    pub(super) fn runtime_host_cmd_open_load_replay_menu(&mut self, _args: &HashMap<String, String>)  {
                let mut wnd_ok = false;
                #[cfg(feature = "game_client")]
                {
    ...
    pub(super) fn runtime_host_cmd_open_keyboard_options(&mut self, _args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_click_keyboard_options(&mut self, args: &HashMap<String, String>)  {
    ...
    pub(super) fn runtime_host_cmd_click_difficulty_select(&mut self, args: &HashMap<String, String>)  {
