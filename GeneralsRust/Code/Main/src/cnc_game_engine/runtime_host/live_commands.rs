...
impl CnCGameEngine {
    pub(super) fn runtime_host_cmd_click_live_command_attack_log(
        &mut self,
    ...
    pub(super) fn runtime_host_cmd_click_live_command_guard_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_production_construction_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_rally_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_evacuate_contain_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_cheer_science_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_deploy_status_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_formation_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_order_target_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_selection_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_non_attack_order_target(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_golden_mopup_default_off(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_beacon_note(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_sell_deselect_log(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_unit_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_unit_more_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_executor_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
    ...
    pub(super) fn runtime_host_cmd_click_live_command_executor_more_authority_api(
        &mut self,
        args: &HashMap<String, String>,
    ) {
        let action = args
