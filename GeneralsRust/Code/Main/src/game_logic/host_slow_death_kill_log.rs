//! Frame-local SlowDeathBehavior kill log for GameWorld shadow parity.
//!
//! Under coupled dual-tick, GW sole-ticks slow-death phases and records kill
//! here so host can destroy without dual-ticking the sink/delay timer.
