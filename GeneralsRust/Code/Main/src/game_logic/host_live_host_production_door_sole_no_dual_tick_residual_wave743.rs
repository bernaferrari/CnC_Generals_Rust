...
pub enum ResidualHostProductionDoorSoleNoDualTickAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostProductionDoorSoleNoDualTickAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_production_door_sole_no_dual_tick_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_production_door_sole_no_dual_tick_last_action() -> ResidualHostProductionDoorSoleNoDualTickAction { ResidualHostProductionDoorSoleNoDualTickAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_production_door_sole_no_dual_tick_method_names_residual_wave743() -> bool {
    ...
    residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::MethodNames); ok
}
pub fn honesty_host_production_door_sole_no_dual_tick_source_markers_residual_wave743() -> bool {
    ...
    residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::SourceMarkers); ok
}
pub fn honesty_host_production_door_sole_no_dual_tick_nav_commands_residual_wave743() -> bool {
    ...
    residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::NavCommands); ok
}
pub fn simulate_host_production_door_sole_no_dual_tick_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::CollectSource); ok
}
pub fn simulate_host_production_door_sole_no_dual_tick_dispatch_source() -> bool {
    let ok=gl_source().contains("Wave 743")
        && gl_source().contains("if !crate::gameworld_shadow::gameworld_production_sole_tick_enabled()");
    residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::DispatchSource); ok
}
...
pub fn simulate_live_host_production_door_sole_no_dual_tick_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostProductionDoorSoleNoDualTickAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_production_door_sole_no_dual_tick_method_names_residual_wave743()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_production_door_sole_no_dual_tick_source_markers_residual_wave743()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_production_door_sole_no_dual_tick_nav_commands_residual_wave743()); }
    #[test] fn sources() { assert!(simulate_host_production_door_sole_no_dual_tick_collect_source()); assert!(simulate_host_production_door_sole_no_dual_tick_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_production_door_sole_no_dual_tick_residual_pack_wave743()); }
    #[test] fn live() { assert!(simulate_live_host_production_door_sole_no_dual_tick_honesty()); assert!(residual_host_production_door_sole_no_dual_tick_ok()); }
}
