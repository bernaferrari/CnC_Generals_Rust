...
pub enum ResidualHostDefaultTemplateOptInAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostDefaultTemplateOptInAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_default_template_opt_in_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_default_template_opt_in_last_action() -> ResidualHostDefaultTemplateOptInAction { ResidualHostDefaultTemplateOptInAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_default_template_opt_in_method_names_residual_wave727() -> bool {
    ...
    residual_action_store(ResidualHostDefaultTemplateOptInAction::MethodNames); ok
}
pub fn honesty_host_default_template_opt_in_source_markers_residual_wave727() -> bool {
    ...
    let gated_train = eng.contains("_ if allow_default_template => \"AmericaInfantryRanger\".to_string()");
    ...
    let ok=eng_ok&&gated_train&&gated_con&&gated_up&&smoke_ok&&!eng.contains("playable_claim = true");
    residual_action_store(ResidualHostDefaultTemplateOptInAction::SourceMarkers); ok
}
...
pub fn honesty_host_default_template_opt_in_nav_commands_residual_wave727() -> bool {
    ...
    residual_action_store(ResidualHostDefaultTemplateOptInAction::NavCommands); ok
}
pub fn simulate_host_default_template_opt_in_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostDefaultTemplateOptInAction::CollectSource); ok
}
pub fn simulate_host_default_template_opt_in_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostDefaultTemplateOptInAction::DispatchSource); ok
}
...
pub fn simulate_live_host_default_template_opt_in_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostDefaultTemplateOptInAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_default_template_opt_in_method_names_residual_wave727()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_default_template_opt_in_source_markers_residual_wave727()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_default_template_opt_in_nav_commands_residual_wave727()); }
    #[test] fn sources() { assert!(simulate_host_default_template_opt_in_collect_source()); assert!(simulate_host_default_template_opt_in_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_default_template_opt_in_residual_pack_wave727()); }
    #[test] fn live() { assert!(simulate_live_host_default_template_opt_in_honesty()); assert!(residual_host_default_template_opt_in_ok()); }
}
