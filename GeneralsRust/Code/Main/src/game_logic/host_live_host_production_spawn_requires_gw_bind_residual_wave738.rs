...
pub enum ResidualHostProductionSpawnRequiresGwBindAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostProductionSpawnRequiresGwBindAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_production_spawn_requires_gw_bind_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_production_spawn_requires_gw_bind_last_action() -> ResidualHostProductionSpawnRequiresGwBindAction { ResidualHostProductionSpawnRequiresGwBindAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_production_spawn_requires_gw_bind_method_names_residual_wave738() -> bool {
    ...
    let ok=residual_name_index(names,"allow_without_bind").is_some()
        && residual_name_index(names,"GENERALS_RUNTIME_HOST_PRODUCTION_SPAWN_WITHOUT_GW_BIND").is_some()
    ...
    residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::MethodNames); ok
}
pub fn honesty_host_production_spawn_requires_gw_bind_source_markers_residual_wave738() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::SourceMarkers); ok
}
pub fn honesty_host_production_spawn_requires_gw_bind_nav_commands_residual_wave738() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::NavCommands); ok
}
pub fn simulate_host_production_spawn_requires_gw_bind_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::CollectSource); ok
}
pub fn simulate_host_production_spawn_requires_gw_bind_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::DispatchSource); ok
}
...
pub fn simulate_live_host_production_spawn_requires_gw_bind_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostProductionSpawnRequiresGwBindAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_production_spawn_requires_gw_bind_method_names_residual_wave738()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_production_spawn_requires_gw_bind_source_markers_residual_wave738()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_production_spawn_requires_gw_bind_nav_commands_residual_wave738()); }
    #[test] fn sources() { assert!(simulate_host_production_spawn_requires_gw_bind_collect_source()); assert!(simulate_host_production_spawn_requires_gw_bind_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_production_spawn_requires_gw_bind_residual_pack_wave738()); }
    #[test] fn live() { assert!(simulate_live_host_production_spawn_requires_gw_bind_honesty()); assert!(residual_host_production_spawn_requires_gw_bind_ok()); }
}
