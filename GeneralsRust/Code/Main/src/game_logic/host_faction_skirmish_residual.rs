...
pub struct PlayerTemplateResidual {
    ...
    /// C++ StartingUnit0 (dozer/worker). Kept for call-site compatibility.
    pub starting_unit0: &'static str,
    /// Wave 832: C++ StartingUnit0..9 residual table (retail often only unit0).
    pub starting_units: [&'static str; 10],
...
pub const PLAYER_TEMPLATE_RESIDUAL_SEEDS: &[PlayerTemplateResidual] = &[
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["AmericaVehicleDozer", "", "", "", "", "", "", "", "", ""],
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["ChinaVehicleDozer", "", "", "", "", "", "", "", "", ""],
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["GLAInfantryWorker", "", "", "", "", "", "", "", "", ""],
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Tank_ChinaVehicleDozer", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_CHINA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Infa_ChinaVehicleDozer", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_CHINA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Nuke_ChinaVehicleDozer", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_CHINA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Chem_GLAInfantryWorker", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_GLA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Demo_GLAInfantryWorker", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_GLA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Slth_GLAInfantryWorker", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_GLA",
        shortcut_button_count: 10,
        playable: true,
        old_faction: false,
    ...
    PlayerTemplateResidual {
        ...
        starting_units: ["Boss_VehicleDozer", "", "", "", "", "", "", "", "", ""],
        intrinsic_science: "SCIENCE_CHINA",
