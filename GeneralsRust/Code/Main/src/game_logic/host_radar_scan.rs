...
//!
//! Fail-closed honesty:
//! - Not full OCL RadarVanPing object spawn / DynamicShroudClearingRangeUpdate
//!   shrink curve / StealthDetectorUpdate parity
...
/// Matches SpecialPower.ini RadiusCursorRadius and System.ini ShroudClearingRange.
...
impl HostRadarScanRegistry {
    ...
    pub fn record_activation(&mut self, scan: HostRadarScan) {
