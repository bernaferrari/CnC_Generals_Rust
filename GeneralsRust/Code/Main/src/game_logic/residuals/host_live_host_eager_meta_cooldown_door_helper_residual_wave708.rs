...
pub fn honesty_host_eager_meta_cooldown_door_helper_source_markers_residual_wave708() -> bool {
    ...
    let eng_ok = eng.contains("eager_apply_host_player_meta_after_logic")
        && eng.contains("eager_apply_host_player_cooldown_after_logic")
        && eng.contains("eager_apply_host_production_door_after_logic")
        && eng.contains("Wave 708: post-logic player-meta");
...
pub fn simulate_host_eager_meta_cooldown_door_helper_collect_source() -> bool {
    let ok = shadow_source().contains("eager_apply_host_player_meta_after_logic")
        ...
        && eng_source().contains("eager_apply_host_player_meta_after_logic");
...
pub fn simulate_host_eager_meta_cooldown_door_helper_dispatch_source() -> bool {
    let ok = eng_source().contains("Wave 708") && shadow_source().contains("Wave 708");
