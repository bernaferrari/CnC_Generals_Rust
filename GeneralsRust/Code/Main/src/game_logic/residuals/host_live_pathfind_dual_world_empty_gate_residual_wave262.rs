...
pub fn honesty_pathfind_dual_world_empty_gate_source() -> bool {
    let g = concat!(
        include_str!("../../../../GameEngine/GameLogic/src/ai/pathfind_complete/types.rs"),
        include_str!("../../../../GameEngine/GameLogic/src/ai/pathfind_complete/construct.rs"),
        include_str!("../../../../GameEngine/GameLogic/src/ai/pathfind_complete/line_passable.rs"),
        include_str!("../../../../GameEngine/GameLogic/src/ai/pathfind_complete/occupancy.rs"),
    );
