...
pub mod harness;
pub use harness::{
    engine_scan_src, host_logic_scan_src, GAME_LOGIC_EVA_CAMERA_SRC, GAME_LOGIC_HOST_SRC,
    GAME_LOGIC_OBJECT_CONSTRUCT_SRC, GAME_LOGIC_OBJECT_ORDERS_SRC, GAME_LOGIC_OBJECT_WEAPONS_SRC,
    GAME_LOGIC_SCRIPTS_CAMERA_SRC, GAME_LOGIC_TANKS_SRC, GAME_LOGIC_UI_PRODUCTION_SRC,
