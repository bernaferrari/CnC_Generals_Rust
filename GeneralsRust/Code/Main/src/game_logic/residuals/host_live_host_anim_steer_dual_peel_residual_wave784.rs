...
pub enum ResidualHostAnimSteerDualPeelAction {
    None = 0,
    MethodNames = 1,
    SourceMarkers = 2,
    NavCommands = 3,
...
fn residual_action_store(a: ResidualHostAnimSteerDualPeelAction) {
    RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst);
}
pub fn residual_host_anim_steer_dual_peel_ok() -> bool {
    RESIDUAL_OK.load(Ordering::SeqCst)
}
pub fn residual_host_anim_steer_dual_peel_last_action() -> ResidualHostAnimSteerDualPeelAction {
...
pub fn honesty_host_anim_steer_dual_peel_method_names_residual_wave784() -> bool {
    ...
    residual_action_store(ResidualHostAnimSteerDualPeelAction::MethodNames);
    ok
}
...
pub fn honesty_host_anim_steer_dual_peel_nav_commands_residual_wave784() -> bool {
    ...
    residual_action_store(ResidualHostAnimSteerDualPeelAction::NavCommands);
    ok
}
pub fn simulate_host_anim_steer_dual_peel_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostAnimSteerDualPeelAction::CollectSource);
    ok
}
pub fn simulate_host_anim_steer_dual_peel_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostAnimSteerDualPeelAction::DispatchSource);
    ok
}
...
pub fn simulate_live_host_anim_steer_dual_peel_honesty() -> bool {
    ...
    if ok {
        ...
        residual_action_store(ResidualHostAnimSteerDualPeelAction::Composite);
    }
    ok
}
...
mod tests {
    ...
    fn method_names_residual() {
        assert!(honesty_host_anim_steer_dual_peel_method_names_residual_wave784());
    }
    #[test]
    fn source_markers_residual() {
        assert!(honesty_host_anim_steer_dual_peel_source_markers_residual_wave784());
    }
    #[test]
    fn nav_commands_residual() {
        assert!(honesty_host_anim_steer_dual_peel_nav_commands_residual_wave784());
    }
    #[test]
    fn sources() {
        assert!(simulate_host_anim_steer_dual_peel_collect_source());
        assert!(simulate_host_anim_steer_dual_peel_dispatch_source());
    }
    #[test]
    fn pack() {
        assert!(honesty_host_anim_steer_dual_peel_residual_pack_wave784());
    }
    #[test]
    fn live() {
        assert!(simulate_live_host_anim_steer_dual_peel_honesty());
        assert!(residual_host_anim_steer_dual_peel_ok());
    }
}
