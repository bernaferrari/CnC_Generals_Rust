...
fn helpers_source() -> &'static str {
    include_str!("../../../../GameEngine/GameLogic/src/helpers.rs")
}
...
pub fn honesty_host_portrait_drawable_presentation_residual_residual_pack_wave1006() -> bool {
    ...
    let ok = portrait.contains("Wave 249/1006")
        && portrait.contains("obj_id.is_none()")
        && portrait.contains("build_queue_data.clear()")
        && (gc.contains("pub fn drawable_count") || helpers.contains("pub fn drawable_count"))
