...
pub fn honesty_script_action_name_table_residual_wave95() -> bool {
    SCRIPT_ACTION_NUM_ITEMS_RESIDUAL == 344
        ...
        && residual_name_index(
            SCRIPT_ACTION_INTERNAL_NAME_TABLE_RESIDUAL,
            "CALL_SUBROUTINE",
        ) == Some(10)
...
pub fn honesty_script_condition_name_table_residual_wave95() -> bool {
    SCRIPT_CONDITION_NUM_ITEMS_RESIDUAL == 109
        ...
        && SCRIPT_CONDITION_INTERNAL_NAME_TABLE_RESIDUAL[108] == "NAMED_HAS_FREE_CONTAINER_SLOTS"
        && residual_name_index(
            SCRIPT_CONDITION_INTERNAL_NAME_TABLE_RESIDUAL,
            "CONDITION_TRUE",
        ) == Some(3)
        && residual_name_index(SCRIPT_CONDITION_INTERNAL_NAME_TABLE_RESIDUAL, "COUNTER") == Some(1)
        && residual_name_index(SCRIPT_CONDITION_INTERNAL_NAME_TABLE_RESIDUAL, "not_a_cond")
            .is_none()
        && residual_name_index_ci(
            SCRIPT_CONDITION_INTERNAL_NAME_TABLE_RESIDUAL,
            "condition_true",
        ) == Some(3)
        && {
