...
pub fn honesty_host_eager_cmdset_disguise_camo_helper_source_markers_residual_wave696() -> bool {
    ...
    let eng_ok = eng.contains("eager_apply_host_command_set_after_logic")
        && eng.contains("eager_apply_host_disguise_after_logic")
        && eng.contains("eager_apply_host_vision_camo_after_logic")
        && eng.contains("Wave 696: post-logic command-set");
...
pub fn simulate_host_eager_cmdset_disguise_camo_helper_collect_source() -> bool {
    let ok = shadow_source().contains("eager_apply_host_command_set_after_logic")
        ...
        && eng_source().contains("eager_apply_host_command_set_after_logic");
...
pub fn simulate_host_eager_cmdset_disguise_camo_helper_dispatch_source() -> bool {
    let ok = eng_source().contains("Wave 696") && shadow_source().contains("Wave 696");
