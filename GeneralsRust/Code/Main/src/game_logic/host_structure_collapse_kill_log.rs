//! Frame-local StructureCollapseUpdate kill log for GameWorld shadow parity.
//!
//! Under coupled dual-tick, GW sole-ticks building collapse and records kill
//! here so host can destroy without dual-ticking the sink collapse.
