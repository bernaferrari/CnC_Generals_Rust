//! Frame-local StructureToppleUpdate kill log for GameWorld shadow parity.
//!
//! Under coupled dual-tick, GW sole-ticks building topple and records kill
//! here so host can destroy without dual-ticking the fall animation.
