...
pub enum ResidualHostTrainTryNamesGoldenOptInAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostTrainTryNamesGoldenOptInAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_train_try_names_golden_opt_in_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_train_try_names_golden_opt_in_last_action() -> ResidualHostTrainTryNamesGoldenOptInAction { ResidualHostTrainTryNamesGoldenOptInAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_train_try_names_golden_opt_in_method_names_residual_wave724() -> bool {
    ...
    residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::MethodNames); ok
}
pub fn honesty_host_train_try_names_golden_opt_in_source_markers_residual_wave724() -> bool {
    ...
    residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::SourceMarkers); ok
}
pub fn honesty_host_train_try_names_golden_opt_in_nav_commands_residual_wave724() -> bool {
    ...
    residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::NavCommands); ok
}
pub fn simulate_host_train_try_names_golden_opt_in_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::CollectSource); ok
}
pub fn simulate_host_train_try_names_golden_opt_in_dispatch_source() -> bool {
    let ok=eng_source().contains("Wave 724")
        && eng_source().contains("host_enqueue_production");
    residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::DispatchSource); ok
}
...
pub fn simulate_live_host_train_try_names_golden_opt_in_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostTrainTryNamesGoldenOptInAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_train_try_names_golden_opt_in_method_names_residual_wave724()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_train_try_names_golden_opt_in_source_markers_residual_wave724()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_train_try_names_golden_opt_in_nav_commands_residual_wave724()); }
    #[test] fn sources() { assert!(simulate_host_train_try_names_golden_opt_in_collect_source()); assert!(simulate_host_train_try_names_golden_opt_in_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_train_try_names_golden_opt_in_residual_pack_wave724()); }
    #[test] fn live() { assert!(simulate_live_host_train_try_names_golden_opt_in_honesty()); assert!(residual_host_train_try_names_golden_opt_in_ok()); }
}
