...
pub enum ResidualHostEagerCombatProjectileHelperAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostEagerCombatProjectileHelperAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_eager_combat_projectile_helper_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_eager_combat_projectile_helper_last_action() -> ResidualHostEagerCombatProjectileHelperAction { ResidualHostEagerCombatProjectileHelperAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_eager_combat_projectile_helper_method_names_residual_wave710() -> bool {
    ...
    residual_action_store(ResidualHostEagerCombatProjectileHelperAction::MethodNames); ok
}
pub fn honesty_host_eager_combat_projectile_helper_source_markers_residual_wave710() -> bool {
    ...
    residual_action_store(ResidualHostEagerCombatProjectileHelperAction::SourceMarkers); ok
}
pub fn honesty_host_eager_combat_projectile_helper_nav_commands_residual_wave710() -> bool {
    ...
    residual_action_store(ResidualHostEagerCombatProjectileHelperAction::NavCommands); ok
}
pub fn simulate_host_eager_combat_projectile_helper_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostEagerCombatProjectileHelperAction::CollectSource); ok
}
pub fn simulate_host_eager_combat_projectile_helper_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostEagerCombatProjectileHelperAction::DispatchSource); ok
}
...
pub fn simulate_live_host_eager_combat_projectile_helper_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostEagerCombatProjectileHelperAction::Composite); }
    ok
}
...
mod tests {
    ...
    #[test] fn method_names_residual() { assert!(honesty_host_eager_combat_projectile_helper_method_names_residual_wave710()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_eager_combat_projectile_helper_source_markers_residual_wave710()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_eager_combat_projectile_helper_nav_commands_residual_wave710()); }
    #[test] fn sources() { assert!(simulate_host_eager_combat_projectile_helper_collect_source()); assert!(simulate_host_eager_combat_projectile_helper_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_eager_combat_projectile_helper_residual_pack_wave710()); }
    #[test] fn live() { assert!(simulate_live_host_eager_combat_projectile_helper_honesty()); assert!(residual_host_eager_combat_projectile_helper_ok()); }
