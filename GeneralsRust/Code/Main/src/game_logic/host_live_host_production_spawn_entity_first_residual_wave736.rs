...
pub enum ResidualHostProductionSpawnEntityFirstAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostProductionSpawnEntityFirstAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_production_spawn_entity_first_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_production_spawn_entity_first_last_action() -> ResidualHostProductionSpawnEntityFirstAction { ResidualHostProductionSpawnEntityFirstAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_production_spawn_entity_first_method_names_residual_wave736() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnEntityFirstAction::MethodNames); ok
}
pub fn honesty_host_production_spawn_entity_first_source_markers_residual_wave736() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnEntityFirstAction::SourceMarkers); ok
}
pub fn honesty_host_production_spawn_entity_first_nav_commands_residual_wave736() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnEntityFirstAction::NavCommands); ok
}
pub fn simulate_host_production_spawn_entity_first_collect_source() -> bool {
    let ok=ready_source().contains("gw_entity_raw")
        && gl_source().contains("push_pending_bind");
    residual_action_store(ResidualHostProductionSpawnEntityFirstAction::CollectSource); ok
}
pub fn simulate_host_production_spawn_entity_first_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostProductionSpawnEntityFirstAction::DispatchSource); ok
}
...
pub fn simulate_live_host_production_spawn_entity_first_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostProductionSpawnEntityFirstAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_production_spawn_entity_first_method_names_residual_wave736()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_production_spawn_entity_first_source_markers_residual_wave736()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_production_spawn_entity_first_nav_commands_residual_wave736()); }
    #[test] fn sources() { assert!(simulate_host_production_spawn_entity_first_collect_source()); assert!(simulate_host_production_spawn_entity_first_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_production_spawn_entity_first_residual_pack_wave736()); }
    #[test] fn live() { assert!(simulate_live_host_production_spawn_entity_first_honesty()); assert!(residual_host_production_spawn_entity_first_ok()); }
}
