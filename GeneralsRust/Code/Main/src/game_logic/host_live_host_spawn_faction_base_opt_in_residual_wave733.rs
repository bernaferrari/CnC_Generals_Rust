...
pub enum ResidualHostSpawnFactionBaseOptInAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostSpawnFactionBaseOptInAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_spawn_faction_base_opt_in_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_spawn_faction_base_opt_in_last_action() -> ResidualHostSpawnFactionBaseOptInAction { ResidualHostSpawnFactionBaseOptInAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_spawn_faction_base_opt_in_method_names_residual_wave733() -> bool {
    ...
    residual_action_store(ResidualHostSpawnFactionBaseOptInAction::MethodNames); ok
}
pub fn honesty_host_spawn_faction_base_opt_in_source_markers_residual_wave733() -> bool {
    ...
    residual_action_store(ResidualHostSpawnFactionBaseOptInAction::SourceMarkers); ok
}
pub fn honesty_host_spawn_faction_base_opt_in_nav_commands_residual_wave733() -> bool {
    ...
    residual_action_store(ResidualHostSpawnFactionBaseOptInAction::NavCommands); ok
}
pub fn simulate_host_spawn_faction_base_opt_in_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostSpawnFactionBaseOptInAction::CollectSource); ok
}
pub fn simulate_host_spawn_faction_base_opt_in_dispatch_source() -> bool {
    let ok=gl_source().contains("Wave 733")
        && gl_source().contains("create_test_map");
    residual_action_store(ResidualHostSpawnFactionBaseOptInAction::DispatchSource); ok
}
...
pub fn simulate_live_host_spawn_faction_base_opt_in_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostSpawnFactionBaseOptInAction::Composite); }
    ok
}
...
mod tests {
    use super::*;
    #[test] fn method_names_residual() { assert!(honesty_host_spawn_faction_base_opt_in_method_names_residual_wave733()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_spawn_faction_base_opt_in_source_markers_residual_wave733()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_spawn_faction_base_opt_in_nav_commands_residual_wave733()); }
    #[test] fn sources() { assert!(simulate_host_spawn_faction_base_opt_in_collect_source()); assert!(simulate_host_spawn_faction_base_opt_in_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_spawn_faction_base_opt_in_residual_pack_wave733()); }
    #[test] fn live() { assert!(simulate_live_host_spawn_faction_base_opt_in_honesty()); assert!(residual_host_spawn_faction_base_opt_in_ok()); }
}
