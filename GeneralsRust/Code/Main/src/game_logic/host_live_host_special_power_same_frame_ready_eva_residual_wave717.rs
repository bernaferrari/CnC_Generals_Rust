...
pub enum ResidualHostSpecialPowerSameFrameReadyEvaAction { None=0,MethodNames=1,SourceMarkers=2,NavCommands=3,CollectSource=4,DispatchSource=5,Composite=6 }
...
fn residual_action_store(a: ResidualHostSpecialPowerSameFrameReadyEvaAction) { RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst); }
pub fn residual_host_special_power_same_frame_ready_eva_ok() -> bool { RESIDUAL_OK.load(Ordering::SeqCst) }
pub fn residual_host_special_power_same_frame_ready_eva_last_action() -> ResidualHostSpecialPowerSameFrameReadyEvaAction { ResidualHostSpecialPowerSameFrameReadyEvaAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst)) }
...
pub fn honesty_host_special_power_same_frame_ready_eva_method_names_residual_wave717() -> bool {
    ...
    residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::MethodNames); ok
}
pub fn honesty_host_special_power_same_frame_ready_eva_source_markers_residual_wave717() -> bool {
    ...
    residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::SourceMarkers); ok
}
pub fn honesty_host_special_power_same_frame_ready_eva_nav_commands_residual_wave717() -> bool {
    ...
    residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::NavCommands); ok
}
pub fn simulate_host_special_power_same_frame_ready_eva_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::CollectSource); ok
}
pub fn simulate_host_special_power_same_frame_ready_eva_dispatch_source() -> bool {
    ...
    residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::DispatchSource); ok
}
...
pub fn simulate_live_host_special_power_same_frame_ready_eva_honesty() -> bool {
    ...
    if ok { RESIDUAL_OK.store(true, Ordering::SeqCst); residual_action_store(ResidualHostSpecialPowerSameFrameReadyEvaAction::Composite); }
    ok
}
...
mod tests {
    ...
    #[test] fn method_names_residual() { assert!(honesty_host_special_power_same_frame_ready_eva_method_names_residual_wave717()); }
    #[test] fn source_markers_residual() { assert!(honesty_host_special_power_same_frame_ready_eva_source_markers_residual_wave717()); }
    #[test] fn nav_commands_residual() { assert!(honesty_host_special_power_same_frame_ready_eva_nav_commands_residual_wave717()); }
    #[test] fn sources() { assert!(simulate_host_special_power_same_frame_ready_eva_collect_source()); assert!(simulate_host_special_power_same_frame_ready_eva_dispatch_source()); }
    #[test] fn pack() { assert!(honesty_host_special_power_same_frame_ready_eva_residual_pack_wave717()); }
    #[test] fn live() { assert!(simulate_live_host_special_power_same_frame_ready_eva_honesty()); assert!(residual_host_special_power_same_frame_ready_eva_ok()); }
