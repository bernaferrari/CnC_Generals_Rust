//! Frame-local HeightDieUpdate kill log for GameWorld shadow parity.
//!
//! Under coupled dual-tick, GW sole-ticks height-die and records kill here so
//! host can destroy without dual-ticking the altitude check.
