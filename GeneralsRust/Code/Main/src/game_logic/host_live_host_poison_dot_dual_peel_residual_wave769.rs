...
pub enum ResidualHostPoisonDotDualPeelAction {
    None = 0,
    MethodNames = 1,
    SourceMarkers = 2,
    NavCommands = 3,
...
fn residual_action_store(a: ResidualHostPoisonDotDualPeelAction) {
    RESIDUAL_ACTION.store(a as u8, Ordering::SeqCst);
}
pub fn residual_host_poison_dot_dual_peel_ok() -> bool {
    RESIDUAL_OK.load(Ordering::SeqCst)
}
pub fn residual_host_poison_dot_dual_peel_last_action() -> ResidualHostPoisonDotDualPeelAction {
    ResidualHostPoisonDotDualPeelAction::from_u8(RESIDUAL_ACTION.load(Ordering::SeqCst))
}
...
pub fn honesty_host_poison_dot_dual_peel_method_names_residual_wave769() -> bool {
    ...
    residual_action_store(ResidualHostPoisonDotDualPeelAction::MethodNames);
    ok
}
...
pub fn honesty_host_poison_dot_dual_peel_nav_commands_residual_wave769() -> bool {
    ...
    residual_action_store(ResidualHostPoisonDotDualPeelAction::NavCommands);
    ok
}
pub fn simulate_host_poison_dot_dual_peel_collect_source() -> bool {
    ...
    residual_action_store(ResidualHostPoisonDotDualPeelAction::CollectSource);
    ok
}
...
pub fn simulate_live_host_poison_dot_dual_peel_honesty() -> bool {
    ...
    if ok {
        ...
        residual_action_store(ResidualHostPoisonDotDualPeelAction::Composite);
    }
    ok
}
...
mod tests {
    ...
    fn method_names_residual() {
        assert!(honesty_host_poison_dot_dual_peel_method_names_residual_wave769());
    }
    #[test]
    fn source_markers_residual() {
        assert!(honesty_host_poison_dot_dual_peel_source_markers_residual_wave769());
    }
    #[test]
    fn nav_commands_residual() {
        assert!(honesty_host_poison_dot_dual_peel_nav_commands_residual_wave769());
    }
    #[test]
    fn sources() {
        assert!(simulate_host_poison_dot_dual_peel_collect_source());
        assert!(simulate_host_poison_dot_dual_peel_dispatch_source());
    }
    #[test]
    fn pack() {
        assert!(honesty_host_poison_dot_dual_peel_residual_pack_wave769());
    }
    #[test]
    fn live() {
        assert!(simulate_live_host_poison_dot_dual_peel_honesty());
        assert!(residual_host_poison_dot_dual_peel_ok());
    }
}
