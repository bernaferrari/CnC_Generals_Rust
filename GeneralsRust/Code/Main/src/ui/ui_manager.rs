...
pub enum UIEvent {
    ...
    /// C++ ControlBar CANCEL_UNIT_BUILD residual (LMB on queue slot productionID).
    CancelUnitProduction {
        template_name: String,
        production_id: u32,
        queue_index: usize,
    },
    /// C++ ControlBar CANCEL_UPGRADE residual (LMB on PRODUCTION_UPGRADE slot).
        ...
        for event in events {
            match event {
                ...
                UIEvent::CancelUnitProduction {
                    ...
                    self.event_queue.push(UIEvent::CancelUnitProduction {
                        template_name,
                        production_id,
                        queue_index,
                    });
                ...
                UIEvent::CancelUpgradeProduction {
                    ...
                    self.event_queue.push(UIEvent::CancelUpgradeProduction {
                        upgrade_name,
                        production_id,
                        queue_index,
                    });
