...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/BlendEdgeTool.h
//! 
...
/// Constants for BlendEdgeTool
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// BlendEdgeTool structure
...
/// Enumeration for BlendEdgeTool types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BlendEdgeToolType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
