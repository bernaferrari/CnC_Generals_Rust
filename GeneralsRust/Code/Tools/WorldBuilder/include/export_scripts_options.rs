...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/ExportScriptsOptions.h
//! 
...
/// Constants for ExportScriptsOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// ExportScriptsOptions structure
...
/// Enumeration for ExportScriptsOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ExportScriptsOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
