...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/BlendMaterial.h
//! 
...
/// Constants for BlendMaterial
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// BlendMaterial structure
...
/// Enumeration for BlendMaterial types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BlendMaterialType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
