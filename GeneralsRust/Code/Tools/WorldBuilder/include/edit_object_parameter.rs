...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/EditObjectParameter.h
//! 
...
/// Constants for EditObjectParameter
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// EditObjectParameter structure
...
/// Enumeration for EditObjectParameter types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum EditObjectParameterType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
