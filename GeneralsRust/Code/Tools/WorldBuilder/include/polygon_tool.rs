//! PolygonTool Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/PolygonTool.h
//! 
...
/// Constants for PolygonTool
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// PolygonTool structure
...
/// Enumeration for PolygonTool types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PolygonToolType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
