...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/EditCondition.h
//! 
...
/// Constants for EditCondition
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// EditCondition structure
...
/// Enumeration for EditCondition types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum EditConditionType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
