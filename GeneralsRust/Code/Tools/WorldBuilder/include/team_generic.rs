//! TeamGeneric Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/TeamGeneric.h
//! 
...
/// Constants for TeamGeneric
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// TeamGeneric structure
...
/// Enumeration for TeamGeneric types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TeamGenericType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
