...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/BaseBuildProps.h
//! 
...
/// Constants for BaseBuildProps
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// BaseBuildProps structure
...
/// Enumeration for BaseBuildProps types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BaseBuildPropsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
