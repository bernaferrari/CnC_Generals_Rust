//! GroveOptions Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/GroveOptions.h
//! 
...
/// Constants for GroveOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// GroveOptions structure
...
/// Enumeration for GroveOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GroveOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
