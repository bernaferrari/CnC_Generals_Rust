...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/ImpassableOptions.h
//! 
...
/// Constants for ImpassableOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// ImpassableOptions structure
...
/// Enumeration for ImpassableOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ImpassableOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
