//! TeamBehavior Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/TeamBehavior.h
//! 
...
/// Constants for TeamBehavior
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// TeamBehavior structure
...
/// Enumeration for TeamBehavior types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TeamBehaviorType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
