...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/TeamObjectProperties.h
//! 
...
/// Constants for TeamObjectProperties
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// TeamObjectProperties structure
...
/// Enumeration for TeamObjectProperties types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TeamObjectPropertiesType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
