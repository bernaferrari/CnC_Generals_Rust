//! NewHeightMap Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/NewHeightMap.h
//! 
...
/// Constants for NewHeightMap
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// NewHeightMap structure
...
/// Enumeration for NewHeightMap types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum NewHeightMapType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
