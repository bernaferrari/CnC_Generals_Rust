...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/GlobalLightOptions.h
//! 
...
/// Constants for GlobalLightOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// GlobalLightOptions structure
...
/// Enumeration for GlobalLightOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GlobalLightOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
