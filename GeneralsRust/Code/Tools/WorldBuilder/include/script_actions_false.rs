...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/ScriptActionsFalse.h
//! 
...
/// Constants for ScriptActionsFalse
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// ScriptActionsFalse structure
...
/// Enumeration for ScriptActionsFalse types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ScriptActionsFalseType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
