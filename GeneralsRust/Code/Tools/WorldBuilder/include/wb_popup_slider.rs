...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WBPopupSlider.h
//! 
...
/// Constants for WbPopupSlider
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WbPopupSlider structure
...
/// Enumeration for WbPopupSlider types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WbPopupSliderType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
