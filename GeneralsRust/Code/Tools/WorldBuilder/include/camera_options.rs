...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/CameraOptions.h
//! 
...
/// Constants for CameraOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// CameraOptions structure
...
/// Enumeration for CameraOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum CameraOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
