...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WorldBuilderView.h
//! 
...
/// Constants for WorldBuilderView
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WorldBuilderView structure
...
/// Enumeration for WorldBuilderView types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WorldBuilderViewType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
