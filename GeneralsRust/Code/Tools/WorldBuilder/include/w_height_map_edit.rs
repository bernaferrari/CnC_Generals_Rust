...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WHeightMapEdit.h
//! 
...
/// Constants for WHeightMapEdit
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WHeightMapEdit structure
...
/// Enumeration for WHeightMapEdit types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WHeightMapEditType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
