//! RulerOptions Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/RulerOptions.h
//! 
...
/// Constants for RulerOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// RulerOptions structure
...
/// Enumeration for RulerOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum RulerOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
