...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WaypointOptions.h
//! 
...
/// Constants for WaypointOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WaypointOptions structure
...
/// Enumeration for WaypointOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WaypointOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
