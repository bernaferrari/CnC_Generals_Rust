...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/TeamReinforcement.h
//! 
...
/// Constants for TeamReinforcement
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// TeamReinforcement structure
...
/// Enumeration for TeamReinforcement types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TeamReinforcementType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
