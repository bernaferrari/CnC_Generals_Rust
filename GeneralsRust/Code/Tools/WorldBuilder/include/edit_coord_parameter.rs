...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/EditCoordParameter.h
//! 
...
/// Constants for EditCoordParameter
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// EditCoordParameter structure
...
/// Enumeration for EditCoordParameter types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum EditCoordParameterType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
