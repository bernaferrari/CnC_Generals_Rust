//! WbHeightMap Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WBHeightMap.h
//! 
...
/// Constants for WbHeightMap
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WbHeightMap structure
...
/// Enumeration for WbHeightMap types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WbHeightMapType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
