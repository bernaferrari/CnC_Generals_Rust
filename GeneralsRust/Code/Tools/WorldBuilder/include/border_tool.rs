//! BorderTool Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/BorderTool.h
//! 
...
/// Constants for BorderTool
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// BorderTool structure
...
/// Enumeration for BorderTool types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BorderToolType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
