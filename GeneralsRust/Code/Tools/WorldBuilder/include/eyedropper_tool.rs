...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/EyedropperTool.h
//! 
...
/// Constants for EyedropperTool
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// EyedropperTool structure
...
/// Enumeration for EyedropperTool types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum EyedropperToolType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
