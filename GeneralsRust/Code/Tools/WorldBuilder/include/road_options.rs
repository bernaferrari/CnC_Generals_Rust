//! RoadOptions Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/RoadOptions.h
//! 
...
/// Constants for RoadOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// RoadOptions structure
...
/// Enumeration for RoadOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum RoadOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
