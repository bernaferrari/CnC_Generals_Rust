...
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/ScriptProperties.h
//! 
...
/// Constants for ScriptProperties
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// ScriptProperties structure
...
/// Enumeration for ScriptProperties types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ScriptPropertiesType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
