//! WaterOptions Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/WaterOptions.h
//! 
...
/// Constants for WaterOptions
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WaterOptions structure
...
/// Enumeration for WaterOptions types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WaterOptionsType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
