//! MapPreview Module
//! 
//! Corresponds to C++ file: Tools/WorldBuilder/include/MapPreview.h
//! 
...
/// Constants for MapPreview
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// MapPreview structure
...
/// Enumeration for MapPreview types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum MapPreviewType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
