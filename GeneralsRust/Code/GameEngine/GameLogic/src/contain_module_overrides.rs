...
fn convert_to_hijacked_vehicle_crate_collide_data_factory(
    ini: Option<&mut INI>,
) -> Box<dyn ModuleData> {
...
fn convert_to_hijacked_vehicle_crate_collide_module_factory(
    thing: Arc<dyn ModuleThing>,
    module_data: Arc<dyn ModuleData>,
) -> Box<dyn Module> {
    let data_arc = cloned_module_data::<
...
fn sabotage_command_center_crate_collide_module_factory(
    thing: Arc<dyn ModuleThing>,
    module_data: Arc<dyn ModuleData>,
) -> Box<dyn Module> {
    let data_arc = cloned_module_data::<
...
fn sabotage_internet_center_crate_collide_module_factory(
    thing: Arc<dyn ModuleThing>,
    module_data: Arc<dyn ModuleData>,
) -> Box<dyn Module> {
    let data_arc = cloned_module_data::<
...
fn sabotage_military_factory_crate_collide_data_factory(
    ini: Option<&mut INI>,
) -> Box<dyn ModuleData> {
...
fn sabotage_military_factory_crate_collide_module_factory(
    thing: Arc<dyn ModuleThing>,
    module_data: Arc<dyn ModuleData>,
) -> Box<dyn Module> {
    let data_arc = cloned_module_data::<
...
fn helicopter_slow_death_data_factory(ini: Option<&mut INI>) -> Box<dyn ModuleData> {
