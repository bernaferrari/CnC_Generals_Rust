// FILE: cash_bounty_power.rs
// Port of CashBountyPower.h and CashBountyPower.cpp
// Author: Rust Port
// Desc: Sets player cash bounty percentage when power is created/initialized
...
/// Module data for CashBounty special power
#[derive(Debug, Clone)]
pub struct CashBountyPowerModuleData {
    ...
    /// Default bounty percentage (0.0 - 1.0)
...
crate::impl_legacy_module_data_with_key_field!(CashBountyPowerModuleData, module_tag_name_key);
...
const CASH_BOUNTY_POWER_FIELDS: &[FieldParse<CashBountyPowerModuleData>] = &[
    ...
    FieldParse {
        token: "Bounty",
        parse: parse_bounty_field,
    },
];

/// Cash bounty special power implementation
#[derive(Debug, Clone)]
pub struct CashBountyPower {
    base: SpecialPowerModule,
    cash_bounty_data: Arc<CashBountyPowerModuleData>,
...
impl CashBountyPower {
    pub fn new(
        ...
        Self {
            base,
            cash_bounty_data: data,
            module_name_key,
        }
    }

    fn find_bounty(&self) -> Real {
        self.cash_bounty_data.default_bounty
    }

    fn apply_bounty(&self, require_science: bool) {
        ...
        if require_science {
            let required = self.base.get_required_science();
            if required != crate::common::science::SCIENCE_INVALID
...
impl ObjSpecialPowerModuleInterface for CashBountyPower {
...
impl EngineSpecialPowerModuleInterface for CashBountyPower {
...
impl Module for CashBountyPower {
    ...
    fn get_module_tag_name_key(&self) -> NameKeyType {
        LegacyModuleData::get_module_tag_name_key(self.cash_bounty_data.as_ref())
    }

    fn get_module_data(&self) -> &dyn ModuleData {
        self.cash_bounty_data.as_ref()
    }

    fn on_object_created(&mut self) {
        self.base.on_object_created();
        self.apply_bounty(true);
    }
}

impl crate::modules::BehaviorModuleInterface for CashBountyPower {
