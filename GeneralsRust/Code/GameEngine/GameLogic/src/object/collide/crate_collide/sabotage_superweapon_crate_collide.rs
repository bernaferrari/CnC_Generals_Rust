...
impl LegacyCollideAdapter for SabotageSuperweaponCrateCollide {
    fn legacy_on_collide(
        ...
        if SabotageSuperweaponCrateCollide::is_valid_to_execute(self, other_id)? {
            let success = SabotageSuperweaponCrateCollide::execute_crate_behavior(self, other_id)?;
    ...
    fn legacy_would_like_to_collide_with(
        ...
        SabotageSuperweaponCrateCollide::is_valid_to_execute(self, other_id)
    }
...
impl CrateCollideModule for SabotageSuperweaponCrateCollide {
    ...
    fn execute_crate_behavior(&mut self, other_id: ObjectID) -> Result<bool, GameError> {
        ...
        SabotageSuperweaponCrateCollide::execute_crate_behavior(self, other_id)
    }
...
mod tests {
    ...
    fn superweapon_sabotage_parse_from_ini_preserves_cpp_base_fields() {
        ...
        assert_ne!(
            data.base.required_kind_of & (KindOf::FSSuperweapon.cpp_mask()),
            0
        );
        assert_ne!(
            data.base.forbidden_kind_of & (KindOf::FSStrategyCenter.cpp_mask()),
            0
        );
