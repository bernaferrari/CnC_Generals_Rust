...
impl LegacyCollideAdapter for SabotageSupplyDropzoneCrateCollide {
    fn legacy_on_collide(
        ...
        if SabotageSupplyDropzoneCrateCollide::is_valid_to_execute(self, other_id)? {
            let success =
                SabotageSupplyDropzoneCrateCollide::execute_crate_behavior(self, other_id)?;
    ...
    fn legacy_would_like_to_collide_with(
        ...
        SabotageSupplyDropzoneCrateCollide::is_valid_to_execute(self, other_id)
    }
...
mod tests {
    ...
    fn steal_cash_amount_parse_from_ini_preserves_cpp_field() {
        ...
        assert_ne!(
            data.base.required_kind_of & (KindOf::FSSupplyDropzone.cpp_mask()),
            0
        );
    }
