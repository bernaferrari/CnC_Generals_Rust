...
pub use conditions::{
    ...
    host_query_player_census, host_query_player_has_science,
    host_query_player_science_purchase_points, host_query_supply_source_attacked,
    host_query_supply_source_safe, host_count_player_kind_in_area,
    host_count_player_type_in_area, host_enemy_sighted, host_object_has_kind,
    host_type_sighted,
    ...
    host_team_was_fielded, merge_host_script_query_snapshot,
