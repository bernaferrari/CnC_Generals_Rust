...
use crate::common::ini::{ini, FieldParse, INI, INIError, INIResult, LookupListRec};
...
pub static KEY_NAMES: &[LookupListRec] = &[
    LookupListRec { name: "KEY_NONE", value: 0 },
    LookupListRec { name: "KEY_ESCAPE", value: 1 },
    LookupListRec { name: "KEY_1", value: 2 },
    LookupListRec { name: "KEY_2", value: 3 },
    LookupListRec { name: "KEY_3", value: 4 },
    LookupListRec { name: "KEY_4", value: 5 },
    LookupListRec { name: "KEY_5", value: 6 },
    LookupListRec { name: "KEY_6", value: 7 },
    LookupListRec { name: "KEY_7", value: 8 },
    LookupListRec { name: "KEY_8", value: 9 },
    LookupListRec { name: "KEY_9", value: 10 },
    LookupListRec { name: "KEY_0", value: 11 },
    LookupListRec { name: "KEY_A", value: 65 },
    LookupListRec { name: "KEY_B", value: 66 },
    LookupListRec { name: "KEY_C", value: 67 },
    LookupListRec { name: "KEY_D", value: 68 },
    LookupListRec { name: "KEY_E", value: 69 },
    LookupListRec { name: "KEY_F", value: 70 },
    LookupListRec { name: "KEY_G", value: 71 },
    LookupListRec { name: "KEY_H", value: 72 },
    LookupListRec { name: "KEY_I", value: 73 },
    LookupListRec { name: "KEY_J", value: 74 },
    LookupListRec { name: "KEY_K", value: 75 },
    LookupListRec { name: "KEY_L", value: 76 },
    LookupListRec { name: "KEY_M", value: 77 },
    LookupListRec { name: "KEY_N", value: 78 },
    LookupListRec { name: "KEY_O", value: 79 },
    LookupListRec { name: "KEY_P", value: 80 },
    LookupListRec { name: "KEY_Q", value: 81 },
    LookupListRec { name: "KEY_R", value: 82 },
    LookupListRec { name: "KEY_S", value: 83 },
    LookupListRec { name: "KEY_T", value: 84 },
    LookupListRec { name: "KEY_U", value: 85 },
    LookupListRec { name: "KEY_V", value: 86 },
    LookupListRec { name: "KEY_W", value: 87 },
    LookupListRec { name: "KEY_X", value: 88 },
    LookupListRec { name: "KEY_Y", value: 89 },
    LookupListRec { name: "KEY_Z", value: 90 },
    LookupListRec { name: "KEY_F1", value: 112 },
    LookupListRec { name: "KEY_F2", value: 113 },
    LookupListRec { name: "KEY_F3", value: 114 },
    LookupListRec { name: "KEY_F4", value: 115 },
    LookupListRec { name: "KEY_F5", value: 116 },
    LookupListRec { name: "KEY_F6", value: 117 },
    LookupListRec { name: "KEY_F7", value: 118 },
    LookupListRec { name: "KEY_F8", value: 119 },
    LookupListRec { name: "KEY_F9", value: 120 },
    LookupListRec { name: "KEY_F10", value: 121 },
    LookupListRec { name: "KEY_F11", value: 122 },
    LookupListRec { name: "KEY_F12", value: 123 },
    LookupListRec { name: "KEY_SPACE", value: 32 },
    LookupListRec { name: "KEY_RETURN", value: 13 },
    LookupListRec { name: "KEY_TAB", value: 9 },
    LookupListRec { name: "KEY_BACKSPACE", value: 8 },
    LookupListRec { name: "KEY_INSERT", value: 45 },
    LookupListRec { name: "KEY_DELETE", value: 46 },
    LookupListRec { name: "KEY_HOME", value: 36 },
    LookupListRec { name: "KEY_END", value: 35 },
    LookupListRec { name: "KEY_PAGEUP", value: 33 },
    LookupListRec { name: "KEY_PAGEDOWN", value: 34 },
    LookupListRec { name: "KEY_UP", value: 38 },
    LookupListRec { name: "KEY_DOWN", value: 40 },
    LookupListRec { name: "KEY_LEFT", value: 37 },
    LookupListRec { name: "KEY_RIGHT", value: 39 },
    LookupListRec { name: "KEY_SHIFT", value: 16 },
    LookupListRec { name: "KEY_CONTROL", value: 17 },
    LookupListRec { name: "KEY_ALT", value: 18 },
];

/// Transition names lookup
pub static TRANSITION_NAMES: &[LookupListRec] = &[
    LookupListRec { name: "Down", value: TRANSITION_DOWN },
    LookupListRec { name: "Up", value: TRANSITION_UP },
    LookupListRec { name: "Repeat", value: TRANSITION_REPEAT },
];

/// Modifier names lookup
pub static MODIFIER_NAMES: &[LookupListRec] = &[
    LookupListRec { name: "None", value: MODIFIER_NONE },
    LookupListRec { name: "Shift", value: MODIFIER_SHIFT },
    LookupListRec { name: "Ctrl", value: MODIFIER_CTRL },
    LookupListRec { name: "Alt", value: MODIFIER_ALT },
    LookupListRec { name: "Shift+Ctrl", value: MODIFIER_SHIFT | MODIFIER_CTRL },
    LookupListRec { name: "Shift+Alt", value: MODIFIER_SHIFT | MODIFIER_ALT },
    LookupListRec { name: "Ctrl+Alt", value: MODIFIER_CTRL | MODIFIER_ALT },
    LookupListRec { name: "Shift+Ctrl+Alt", value: MODIFIER_SHIFT | MODIFIER_CTRL | MODIFIER_ALT },
];

/// Category names lookup
pub static CATEGORY_NAMES_LOOKUP: &[LookupListRec] = &[
    LookupListRec { name: "SELECTION", value: 0 },
    LookupListRec { name: "INTERFACE", value: 1 },
    LookupListRec { name: "GAME", value: 2 },
    LookupListRec { name: "DEBUG", value: 3 },
];
...
const META_MAP_FIELD_PARSE_TABLE: &[FieldParse<MetaMapRec>] = &[
    FieldParse { token: "Key", parse: parse_key },
    FieldParse { token: "Transition", parse: parse_transition },
    FieldParse { token: "Modifiers", parse: parse_modifiers },
    FieldParse { token: "UseableIn", parse: parse_usable_in },
    FieldParse { token: "Category", parse: parse_category },
    FieldParse { token: "Description", parse: parse_description },
    FieldParse { token: "DisplayName", parse: parse_display_name },
];
...
mod tests {
    ...
    fn test_meta_map_creation() {
        ...
        assert!(map.find_action(65, TRANSITION_DOWN, MODIFIER_CTRL).is_some());
    }
    ...
    fn test_lookup_lists() {
        ...
        assert_eq!(INI::parse_lookup_list("Down", TRANSITION_NAMES).unwrap(), TRANSITION_DOWN);
        assert_eq!(INI::parse_lookup_list("Ctrl", MODIFIER_NAMES).unwrap(), MODIFIER_CTRL);
    }
}
