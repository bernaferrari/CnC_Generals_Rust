...
fn game_win_draw_table() -> Vec<TableEntry> {
    vec![
        ...
        TableEntry::new(
            ...
            Some(draw_func_ptr(w3d_gadget_horizontal_slider_image_draw_a)),
        ),
        TableEntry::new(
            "W3DGadgetHorizontalSliderImageDrawB",
            Some(draw_func_ptr(w3d_gadget_horizontal_slider_image_draw_b)),
        ),
        TableEntry::new(
        ...
        TableEntry::new(
            ...
            Some(draw_func_ptr(w3d_gadget_progress_bar_image_draw_a)),
        ),
        TableEntry::new(
        ...
        TableEntry::new("W3DPowerDrawA", Some(draw_func_ptr(w3d_power_draw_a))),
        ...
        TableEntry::new(
            "W3DDrawMapPreview",
            Some(draw_func_ptr(w3d_draw_map_preview)),
        ),
    ]
}
