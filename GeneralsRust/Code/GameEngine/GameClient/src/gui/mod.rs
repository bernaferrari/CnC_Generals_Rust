...
pub use game_window::{
    ...
    gadget_combo_box_reset, gadget_combo_box_set_ascii_only, gadget_combo_box_set_colors,
    gadget_combo_box_set_is_editable, gadget_combo_box_set_item_data,
    gadget_combo_box_set_letters_and_numbers_only, gadget_combo_box_set_max_chars,
    gadget_combo_box_set_max_display, gadget_combo_box_set_selected_pos, gadget_combo_box_set_text,
...
pub use shell::{
    ...
    with_shell_mut, with_shell_ref, AnimateWindowManager, AnimationType, Color, Coord2D,
    GameDifficulty, LayoutState, ResidualShellMapAction, Shell, ShellError, ShellHandle,
    ShellMenuScheme, ShellMenuSchemeManager, ShowSide, WindowLayout as ShellWindowLayout,
    WindowRect,
};
