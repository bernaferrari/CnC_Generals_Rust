...
pub fn WOLStatusMenuInit(layout: &WindowLayout, user_data: Option<&dyn std::any::Any>) {
    wol_status_menu_init(layout, user_data);
}

pub fn WOLStatusMenuUpdate(layout: &WindowLayout, user_data: Option<&dyn std::any::Any>) {
    wol_status_menu_update(layout, user_data);
}

pub fn WOLStatusMenuShutdown(layout: &WindowLayout, user_data: Option<&dyn std::any::Any>) {
