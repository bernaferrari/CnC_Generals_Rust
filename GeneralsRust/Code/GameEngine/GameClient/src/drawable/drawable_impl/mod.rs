...
//!
//! Split from the former `drawable/drawable.rs` god-file. Public names stay
//! identical so `crate::drawable::drawable::*` keeps working. The original
//! `drawable.rs` remains on disk as a scan dump (not compiled).
