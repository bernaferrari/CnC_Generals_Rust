...
impl W3DDynamicLight {
    ...
    pub fn calculate_contribution(&self, point: Vector3<f32>, normal: Vector3<f32>) -> LightContribution {
...
impl LightEnvironment {
    ...
    pub fn calculate_lighting(&self, point: Vector3<f32>, normal: Vector3<f32>) -> LightContribution {
