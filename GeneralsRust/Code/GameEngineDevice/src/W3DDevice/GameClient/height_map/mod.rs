...
pub use world_height_map::{
    ExtraAlphaUvData, ICoord2D, TBlendTileInfo, TCliffInfo, TXTextureClass, WorldHeightMap,
    FLAG_VAL, FLIPPED_MASK, INVERTED_MASK, K_MAX_HEIGHT, K_MIN_HEIGHT, NORMAL_DRAW_HEIGHT,
    NORMAL_DRAW_WIDTH, NUM_ALPHA_TILES, NUM_BLEND_TILES, NUM_CLIFF_INFO, NUM_SOURCE_TILES,
    NUM_TEXTURE_CLASSES, STRETCH_DRAW_HEIGHT, STRETCH_DRAW_WIDTH, TEXTURE_WIDTH, TILE_PIXEL_EXTENT,
};
