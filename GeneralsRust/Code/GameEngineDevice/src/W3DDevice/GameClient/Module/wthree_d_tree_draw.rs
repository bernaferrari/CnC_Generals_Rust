...
//!
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DTreeDraw.h
//!
...
/// Constants for WthreeDTreeDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDTreeDraw structure
...
/// Enumeration for WthreeDTreeDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDTreeDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
