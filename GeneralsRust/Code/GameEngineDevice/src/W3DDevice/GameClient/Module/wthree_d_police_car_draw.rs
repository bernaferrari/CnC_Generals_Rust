...
//! 
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DPoliceCarDraw.h
//! 
...
/// Constants for WthreeDPoliceCarDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDPoliceCarDraw structure
...
/// Enumeration for WthreeDPoliceCarDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDPoliceCarDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
