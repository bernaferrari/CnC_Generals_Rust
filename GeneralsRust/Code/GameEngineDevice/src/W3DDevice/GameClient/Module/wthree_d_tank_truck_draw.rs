...
//! 
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DTankTruckDraw.h
//! 
...
/// Constants for WthreeDTankTruckDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDTankTruckDraw structure
...
/// Enumeration for WthreeDTankTruckDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDTankTruckDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
