...
//!
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DScienceModelDraw.h
//!
...
/// Constants for WthreeDScienceModelDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDScienceModelDraw structure
...
/// Enumeration for WthreeDScienceModelDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDScienceModelDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
