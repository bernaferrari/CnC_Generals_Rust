...
/// Constants for WthreeDOverlordAircraftDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDOverlordAircraftDraw structure
...
/// Enumeration for WthreeDOverlordAircraftDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDOverlordAircraftDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
