...
//! 
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DModelDraw.h
//! 
...
/// Constants for WthreeDModelDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDModelDraw structure
...
/// Enumeration for WthreeDModelDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDModelDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
