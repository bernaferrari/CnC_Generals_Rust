...
//! 
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/GameClient/Module/W3DSupplyDraw.h
//! 
...
/// Constants for WthreeDSupplyDraw
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDSupplyDraw structure
...
/// Enumeration for WthreeDSupplyDraw types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDSupplyDrawType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
