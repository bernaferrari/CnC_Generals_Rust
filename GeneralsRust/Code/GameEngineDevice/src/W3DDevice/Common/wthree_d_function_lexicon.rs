...
//! 
//! Corresponds to C++ file: GameEngineDevice/Include/W3DDevice/Common/W3DFunctionLexicon.h
//! 
...
/// Constants for WthreeDFunctionLexicon
pub const DEFAULT_VALUE: u32 = 0;
pub const MAX_VALUE: u32 = 1000;

/// WthreeDFunctionLexicon structure
...
/// Enumeration for WthreeDFunctionLexicon types
#[repr(u32)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum WthreeDFunctionLexiconType {
    /// Default type
    Default = 0,
    /// Custom type
    Custom = 1,
