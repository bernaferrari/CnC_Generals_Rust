...
`writeback_construction_to_host` is construction/sell/rebuild only; combat status, AI state, contain, supplies, veterancy, and special-power use dedicated session writebacks.
